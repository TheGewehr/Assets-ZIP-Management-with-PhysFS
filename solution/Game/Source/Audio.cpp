...
bool Audio::PlayMusic(const char* path, float fadeTime)
{
	...
	// (SOLVED) TODO 8: Repeat the process that we have done for the texture but with the music (don't have to close the SDL_RWops structure)
...
unsigned int Audio::LoadFx(const char* path)
{
	...
	// (SOLVED) TODO 8: Repeat the process that we have done for the texture but with the sound effects (close the structure this time)
